...
public class Home_Fragment  extends Fragment implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            ...
            fragmentManager
                    .beginTransaction().replace(R.id.fragment_container, new Emergency_Fragment()).commit();
            break;
            case R.id.card_report :
                fragmentManager
                        .beginTransaction().replace(R.id.fragment_container, new Report_Fragment()).commit();
                break;
            case R.id.card_govinfo :
                fragmentManager
                        .beginTransaction().replace(R.id.fragment_container, new Govinfo_Fragment()).commit();
                break;
                case R.id.card_feedback :
                fragmentManager
                        .beginTransaction().replace(R.id.fragment_container, new Feedback_Fragment()).commit();
                break;
